...
```
Se puede apreciar como la clase empresa practicamente hace toda la labor del sistema, luego de aplicar refactoring el sistema queda mucho mas cohesivo. Cada clase cumplirá con su labor que le corresponde.

***Aclaración: Al realizar cambios mayores en la funcionalidad del sistema se tuvo que modificar los test para que estos mismos funcionen.***
### Test post aplicar refactoring
``` java
package ar.edu.unlp.info.oo2.facturacion_llamadas;
